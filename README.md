...
This project does not use any libraries so it will run on all devices no problem! Just make sure to download the python script and the .json file with all the words.
